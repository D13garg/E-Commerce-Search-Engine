...
import { forgotPasswordInitiate, AuthApiError } from '@/lib/auth'
    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '400px' }}>
        ...
        <div style={{
          ...
          <p style={{ marginTop: '20px', textAlign: 'center', fontFamily: 'var(--font-mono)', fontSize: '11px', color: 'var(--text-3)' }}>
